...
const styles = StyleSheet.create({
    ...
    header: { paddingTop: 22, paddingHorizontal: 16, paddingBottom: 10, borderBottomLeftRadius: 16, borderBottomRightRadius: 16, backgroundColor: '#edf7f1' },
    title: { color: '#0f2f1f', fontSize: 18, fontWeight: '800', letterSpacing: 0.35 },

    actions: { paddingHorizontal: 16, paddingBottom: 12, borderTopLeftRadius: 16, borderTopRightRadius: 16, backgroundColor: '#edf7f1' },
    btn: {
    ...
    btnText: { color: '#0b1f15', fontWeight: '800', letterSpacing: 0.2 },

    placeholder: { flex: 1, alignItems: 'center', justifyContent: 'center', padding: 20 },
    placeholderText: { color: '#3f5f4c', textAlign: 'center' },
    errorText: { marginTop: 8, color: '#b91c1c' },
    ...
    svg: { alignSelf: 'center', borderRadius: 12, backgroundColor: '#f7fcf9' },

    legend: { flexDirection: 'row', alignItems: 'center', gap: 16, marginTop: 10 },
    legendItem: { flexDirection: 'row', alignItems: 'center' },
    legendText: { color: '#1f2937', fontWeight: '600' },

    stats: {
        marginTop: 12,
        borderTopWidth: StyleSheet.hairlineWidth,
        borderTopColor: '#d9e9de',
        paddingTop: 8,
        gap: 4,
    },
    row: { flexDirection: 'row', justifyContent: 'space-between', paddingVertical: 4 },
    rowLabel: { color: '#3b5546' },
