...
import { GardenAnnotation } from '../services/objectPlannerService';
...
const InfoGroup: React.FC<{ title: string; children: React.ReactNode; style?: StyleProp<ViewStyle> }> = ({
  ...
  <StyledView className="bg-white border border-green-200 rounded-lg p-3 flex-1 min-w-[48%]" style={style}>
      ...
      <StyledView className="p-5 items-center">
        ...
        <StyledView className="bg-green-50/70 border border-green-200 rounded-xl p-3 w-full mt-2 space-y-3">
          ...
          <StyledView>
            ...
            <StyledView className="flex-row gap-2.5 mt-2.5 flex-wrap items-stretch">
